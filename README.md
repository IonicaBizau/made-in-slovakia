...
7 | [@petersirka](https://github.com/petersirka)/[**partial.js-clientsid…**](https://github.com/petersirka/partial.js-clientside) | A simple routing through HTML 5 History API according to partial.js. | [:arrow_upper_right:](http://www.totaljs.com)
...
15 | [@danzatt](https://github.com/danzatt)/[**ibex_find**](https://github.com/danzatt/ibex_find) | Identifies common functions in iBSS/iBEC/iBoot/LLB |
11 | [@lovasko](https://github.com/lovasko)/[**libctf**](https://github.com/lovasko/libctf) | BSD-licensed CTF Implementation |
7 | [@cTn-dev](https://github.com/cTn-dev)/[**Phoenix-STM32**](https://github.com/cTn-dev/Phoenix-STM32) | Flight Controller designed for SAR operations |
7 | [@danzatt](https://github.com/danzatt)/[**hfs_resize**](https://github.com/danzatt/hfs_resize) | Resize HFS on iOS |
3 | [@v92](https://github.com/v92)/[**libiorouter**](https://github.com/v92/libiorouter) | libiorouter is LD_PRELOAD library for caching data and metadata requests from backend directory to local directory transparently to application. |
3 | [@lovasko](https://github.com/lovasko)/[**libcsv**](https://github.com/lovasko/libcsv) | C89 Comma Separated Values Implementation |
2 | [@nandra](https://github.com/nandra)/[**libiqrf**](https://github.com/nandra/libiqrf) | interface library to iqrf devices | [:arrow_upper_right:](www.open-nandra.com)
2 | [@nandra](https://github.com/nandra)/[**ctimer**](https://github.com/nandra/ctimer) | ctimer is console periodic or one-shot timer. | [:arrow_upper_right:](www.open-nandra.com)
2 | [@danzatt](https://github.com/danzatt)/[**QEMU-s5l89xx-port**](https://github.com/danzatt/QEMU-s5l89xx-port) | Adding support s5l89xx support to QEMU | [:arrow_upper_right:](www.cmw.me)
2 | [@danzatt](https://github.com/danzatt)/[**reimagine**](https://github.com/danzatt/reimagine) | Tool based on opensn0w-X for dumping, listing, decrypting and patching IMG3 files |
2 | [@nandra](https://github.com/nandra)/[**omap_850_kernel**](https://github.com/nandra/omap_850_kernel) |  |
...
284 | [@nem0](https://github.com/nem0)/[**LumixEngine**](https://github.com/nem0/LumixEngine) | 3D Game Engine | [:arrow_upper_right:](https://github.com/nem0/lumixengine_data)
21 | [@matus-chochlik](https://github.com/matus-chochlik)/[**oglplu2**](https://github.com/matus-chochlik/oglplu2) | Experimental rewrite of OGLplus with the latest C++ features and a different design. |
9 | [@mireq](https://github.com/mireq)/[**minetest-mapper-cpp**](https://github.com/mireq/minetest-mapper-cpp) | Port of minetest map generator. |
8 | [@matus-chochlik](https://github.com/matus-chochlik)/[**eagine**](https://github.com/matus-chochlik/eagine) | A rendering engine based on eglplus/oalplus/oglplus (in very early stages of development)  |
8 | [@breviar-sk](https://github.com/breviar-sk)/[**Liturgia-hodin-onlin…**](https://github.com/breviar-sk/Liturgia-hodin-online) | Liturgia hodín (breviár) online / Liturgy of Hours (Breviary): Slovak, Czech, Hungarian | [:arrow_upper_right:](http://breviar.sk)
5 | [@mireq](https://github.com/mireq)/[**Qt-Quick-Keyboard**](https://github.com/mireq/Qt-Quick-Keyboard) | Simple virtual keyboard written in Qt Quick |
4 | [@tkislan](https://github.com/tkislan)/[**base64**](https://github.com/tkislan/base64) | Base64 encoding and decoding for C++ projects |
3 | [@matus-tomlein](https://github.com/matus-tomlein)/[**synkron**](https://github.com/matus-tomlein/synkron) | Synkron is an application for synchronising folders. | [:arrow_upper_right:](synkron.sourceforge.net)
3 | [@GAMELASTER](https://github.com/GAMELASTER)/[**ArduinoGamepad**](https://github.com/GAMELASTER/ArduinoGamepad) | A GamePad HID library for Arduino Pro Micro/Leonardo (ATMega32u4) |
3 | [@matus-chochlik](https://github.com/matus-chochlik)/[**mirror**](https://github.com/matus-chochlik/mirror) | Reboot of the Mirror reflection utilities (in very early stage) |
3 | [@kaplon](https://github.com/kaplon)/[**mangos**](https://github.com/kaplon/mangos) |  | [:arrow_upper_right:](http://getmangos.com)
3 | [@mhozza](https://github.com/mhozza)/[**HandControl**](https://github.com/mhozza/HandControl) | Tool for remote controlling PC only with your hand and webcamera. |
2 | [@nem0](https://github.com/nem0)/[**playground**](https://github.com/nem0/playground) | Idea testbed |
...
12 | [@mkottman](https://github.com/mkottman)/[**wdm**](https://github.com/mkottman/wdm) | web data mining - a small utility library for Lua for easy HTTP mining with curl & sqlite3 |
6 | [@mkottman](https://github.com/mkottman)/[**ffi_fun**](https://github.com/mkottman/ffi_fun) | Various examples of (ab)using of the LuaJIT FFI |
...
335 | [@peterpaulis](https://github.com/peterpaulis)/[**StaticDataTableViewC…**](https://github.com/peterpaulis/StaticDataTableViewController) | Enables to hide static cells |
332 | [@Tricertops](https://github.com/Tricertops)/[**Block-KVO**](https://github.com/Tricertops/Block-KVO) | Objective-C Key-Value Observing made easier with blocks |
243 | [@Tricertops](https://github.com/Tricertops)/[**Objective-Chain**](https://github.com/Tricertops/Objective-Chain) | Object-oriented reactive framework, inspired by ReactiveCocoa |
189 | [@peterpaulis](https://github.com/peterpaulis)/[**M6ParallaxController**](https://github.com/peterpaulis/M6ParallaxController) | Parallax controller for a parallaxed view and a table view |
161 | [@Tricertops](https://github.com/Tricertops)/[**UIView-AnimatedPrope…**](https://github.com/Tricertops/UIView-AnimatedProperty) | Extending `UIView` block animations to allow you to implement custom animated properties. |
104 | [@Tricertops](https://github.com/Tricertops)/[**Grand-Object-Dispatc…**](https://github.com/Tricertops/Grand-Object-Dispatch) | Objective-C wrapper for Grand Central Dispatch |
85 | [@peterpaulis](https://github.com/peterpaulis)/[**M6UniversalParallaxV…**](https://github.com/peterpaulis/M6UniversalParallaxViewController) |  |
52 | [@Tricertops](https://github.com/Tricertops)/[**Typed**](https://github.com/Tricertops/Typed) | Statically typed Objective-C collections |
39 | [@kukosk](https://github.com/kukosk)/[**JKKeyboard**](https://github.com/kukosk/JKKeyboard) | JKKeyboard keeps track of the keyboard frame, and lets you manage your scroll view insets along with custom views' frames the easy way, handling animations completely transparently for you. It will also help you scrolling down your scroll views with the keyboard when appropriate. |
37 | [@peterpaulis](https://github.com/peterpaulis)/[**UIViewController--Co…**](https://github.com/peterpaulis/UIViewController--Container-) | Category for inserting child view controller |
30 | [@Tricertops](https://github.com/Tricertops)/[**ITNDescription**](https://github.com/Tricertops/ITNDescription) | Automatic and smart -debugDescription for every Objective-C class. |
23 | [@Tricertops](https://github.com/Tricertops)/[**Valid-KeyPath**](https://github.com/Tricertops/Valid-KeyPath) | Allows you to specify Objective-C key-paths using symbols taking all advantages – code-completion, complite-time validation, refactoring. |
19 | [@vojto](https://github.com/vojto)/[**Slap**](https://github.com/vojto/Slap) |  |
19 | [@Tricertops](https://github.com/Tricertops)/[**MTKButtonState**](https://github.com/Tricertops/MTKButtonState) | Allows you to set UIButton state-based properties with dot syntax. |
12 | [@vojto](https://github.com/vojto)/[**RKSyntaxView**](https://github.com/vojto/RKSyntaxView) | Simple NSTextView subclass that highlights source code using regular expressions | [:arrow_upper_right:](http://rinik.net)
11 | [@Tricertops](https://github.com/Tricertops)/[**NSObject-GCD**](https://github.com/Tricertops/NSObject-GCD) | NSObject+GCD: Category on NSObject with methods that wrap some of the GCD functions. |
7 | [@peterpaulis](https://github.com/peterpaulis)/[**M6GPSLocationManager**](https://github.com/peterpaulis/M6GPSLocationManager) | Cocoa iOS Location manager based on CLLocationManager |
7 | [@Tricertops](https://github.com/Tricertops)/[**Yield**](https://github.com/Tricertops/Yield) | Support for multiple entry points and return values in Objective-C. |
5 | [@Tricertops](https://github.com/Tricertops)/[**Essentials**](https://github.com/Tricertops/Essentials) | Collection of categories, functions, macros and classes that are essential part of my projects. |
5 | [@Tricertops](https://github.com/Tricertops)/[**Where**](https://github.com/Tricertops/Where) | Locate the user of the current iOS device without CoreLocation. |
5 | [@peterpaulis](https://github.com/peterpaulis)/[**BufferOutputStreamTo…**](https://github.com/peterpaulis/BufferOutputStreamToInputStream) | Enables to have an Buffered output stream, linked to to an input stream... this is useful when testing, or when you need to simulate an input stream, that is refilled with local data |
4 | [@vojto](https://github.com/vojto)/[**dr0**](https://github.com/vojto/dr0) | Show your iPad drawings to friends in real time |
3 | [@Tricertops](https://github.com/Tricertops)/[**LinearKit**](https://github.com/Tricertops/LinearKit) | Objective-C wrapper for Accelerate framework. |
3 | [@Tricertops](https://github.com/Tricertops)/[**RichArchiver**](https://github.com/Tricertops/RichArchiver) | Archivation tool for `NSAttributedStrings` for cross-platform exchange – OS X to iOS |
...
2 | [@orthes](https://github.com/orthes)/[**marvin-pages**](https://github.com/orthes/marvin-pages) | Pages plugin for Marvin - micro CMS for PHP 5.3 based on Silex framework |
...
3 | [@sergejx](https://github.com/sergejx)/[**oxalis**](https://github.com/sergejx/oxalis) | Web site editor for Gnome | [:arrow_upper_right:](http://sergejx.mysteria.cz/oxalis/)
